...
config['modelpath_inject'] = os.path.join("models","INJ") #path to save/load trained models and normalization parameters for injector
config['modelpath_remove'] = os.path.join("models","REM") #path to save/load trained models and normalization parameters for remover
